...
public:
    ...
    int currentAnimation = 3; // 3: Idle, 1: Walking, 2: Rare Idle
    ...
    void render() {
        ...
        if (currentAnimation == 1) {
            spriteRowIndex = 3; // Idle animation (third row)
        } else if (currentAnimation == 2) {
            spriteRowIndex = 1; // Walking animation (first row)
        } else {
            spriteRowIndex = 2; // Rare movement animation (second row)
        }
